...
const cardDataProgram=[
  ...
  { id:5, title: 'Card 5', content:'Content for card 4', Link:"",imgBackground: csharp_card },
];
const cardDataScience=[
  { id:1, title: 'JavaScript', content:'s', Link:"./Login", imgBackground:Database},
  ...
  return(
    <IonPage>
      ...
      <IonContent fullscreen>
        ...
        <IonItem>
          <IonHeader className='montserrat-Parrafos-font'>Topicos de ciencias de la computacion</IonHeader>
        </IonItem>
        <IonItem>
